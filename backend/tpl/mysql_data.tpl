<fieldset class="mt-4">
	<legend>Enter MySQL Data</legend>
<form action="{formaction}" method="POST">
	...
	<div class="form-group row justify-content-end">
		<div class="col-sm-9">
			<button class="btn btn-default" name="update" value="update_mysql">save data</button>
			<button class="btn btn-default ms-1" name="generate_config_file" value="generate">Generate config file</button>
		</div>
	</div>
